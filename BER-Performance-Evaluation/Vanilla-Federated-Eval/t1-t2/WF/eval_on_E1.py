...
parser.add_argument("--side_net_path", type=str, default=root_path+"/Collaborative-Train/Vanilla-Federated/t1-t2/WF/Cache/global_model_parameters_38.pkl", required=False)
...
parser.add_argument("--res_save_path", type=str, default=root_path+"/BER-Performance-Evaluation/Vanilla-Federated-Eval/t1-t2/WF/eval_res_on_E1.pkl", required=False)
