...
parser.add_argument("--side_net_path", type=str, default=root_path+"/Collaborative-Train/Vanilla-Federated/t1-t2/NF/Cache/global_model_parameters_60.pkl", required=False)
parser.add_argument("--eval_data_folder", type=str, default=root_path+"/BER-Performance-Evaluation/Eval-Data/TDLB-500-5", required=False)
...
parser.add_argument("--res_save_path", type=str, default=root_path+"/BER-Performance-Evaluation/Vanilla-Federated-Eval/t1-t2/NF/eval_res_on_E1.pkl", required=False)
