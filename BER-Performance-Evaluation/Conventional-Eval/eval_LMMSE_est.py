...
parser.add_argument("--res_save_path", type=str, default=root_path+"/BER-Performance-Evaluation/Conventional-Eval/eval_res_lmmse_on_E1.pkl", required=False)
...
from Utils.Functions.Eval.EvalLmmseEst import EvalLmmseEst
...
if __name__=='__main__':
    ...
    obj = EvalLmmseEst(config=BasicConfig(tdl_model='B',
                                          delay_spread=460e-9,
                                          min_speed=0,
                                          max_speed=5))
    ber = dict()
