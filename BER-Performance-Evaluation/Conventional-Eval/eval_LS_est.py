...
parser.add_argument("--res_save_path", type=str, default=root_path+"/BER-Performance-Evaluation/Conventional-Eval/eval_res_ls_on_E2.pkl", required=False)
...
from Utils.Functions.Eval.EvalLsEst import EvalLsEst
...
if __name__=='__main__':
    ...
    obj = EvalLsEst(config=BasicConfig())
    ber = dict()
