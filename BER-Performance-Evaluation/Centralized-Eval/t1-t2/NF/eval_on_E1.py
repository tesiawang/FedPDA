...
parser.add_argument("--side_net_path", type=str, default=root_path+"/Collaborative-Train/Centralized/t1-t2/NF/Adapted-Models/updated_parameters_13.pkl", required=False)
...
parser.add_argument("--res_save_path", type=str, default=root_path+"/BER-Performance-Evaluation/Centralized-Eval/t1-t2/NF/eval_res_on_E1.pkl", required=False)
