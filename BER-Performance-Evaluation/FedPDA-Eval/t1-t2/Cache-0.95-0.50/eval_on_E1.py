...
parser.add_argument("--side_net_path", type=str, default=root_path+"/Collaborative-Train/FedPDA/t1-t2/Cache-0.95-0.50/global_model_parameters_35.pkl", required=False)
...
parser.add_argument("--res_save_path", type=str, default=root_path+"/BER-Performance-Evaluation/FedPDA-Eval/t1-t2/Cache-0.95-0.50/eval_res_on_E1.pkl", required=False)
