...
parser.add_argument("--model_save_folder", type=str, default=root_path+"/Offline-Pretrain/Pretrained-Models/CNNSideNet/Initialized-CNNSideNet", required=False)
parser.add_argument("--num_epoches", type=int, default=10, required=False)
