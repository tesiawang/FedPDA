...
parser.add_argument("--tdl_model", type=str, default="A", required=False)
parser.add_argument("--delay_spread", type=float, default=50e-9, required=False)
parser.add_argument("--min_speed", type=float, default=0, required=False)
parser.add_argument("--max_speed", type=float, default=1.5, required=False)

parser.add_argument("--min_ebNo", type=float, default=4, required=False)
parser.add_argument("--max_ebNo", type=float, default=20, required=False)
parser.add_argument("--num_ebNo_points", type=int, default=17, required=False)
parser.add_argument("--num_batches_per_dB", type=int, default=200, required=False)
