...
parser.add_argument("--data_save_folder", type=str, default=root_path+"/Collaborative-Train/Online-Val-Data", required=False)
...
parser.add_argument("--num_batches_per_user", type=int, default=23, required=False)
