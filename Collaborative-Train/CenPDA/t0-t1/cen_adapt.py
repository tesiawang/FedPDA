...
parser.add_argument("--model_save_folder", type=str, default=root_path+"/Collaborative-Train/CenPDA/t0-t1/Online-Adapted-Models/From-0.80-Pruned-Data", required=False)
parser.add_argument("--max_epoches", type=int, default=80, required=False)
parser.add_argument("--lr", type=float, default=1e-3, required=False)
parser.add_argument("--training_data_folder", type=str, default=root_path+"/Collaborative-Train/CenPDA/t0-t1/Local-Pruned-Data/0.80", required=False)
