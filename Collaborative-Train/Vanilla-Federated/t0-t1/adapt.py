...
parser.add_argument("--side_net_path", type=str, default=root_path+"/Offline-Pretrain/Pretrained-Models/CNNSideNet/Pretrained-CNNSideNet/updated_parameters_29.pkl", required=False)
parser.add_argument("--cache_folder", type=str, default=root_path+"/Collaborative-Train/Vanilla-Federated/t0-t1/Cache", required=False)
